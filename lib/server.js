export default class Server {
    ...
    countDocuments(query,tagsquery) {
        return fetch(this.url + "/count?text=" + encodeURIComponent(query) + tagsquery).then(r => r.json());
    }
    ...
    getDocuments(query,tagsquery,limit,offset) {
        return fetch(this.url + "/doc?text=" + encodeURIComponent(query) + tagsquery + "&limit=" + limit + "&offset=" + offset).then(r => r.json());
    }
