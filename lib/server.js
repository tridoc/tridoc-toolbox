export default class Server {
    ...
    countDocuments(query,) {
        return fetch(this.url + "/count?text=" + encodeURIComponent(query)).then(r => r.json());
    }
    ...
    getDocuments(query,limit,offset) {
        return fetch(this.url + "/doc?text=" + encodeURIComponent(query) + "&limit=" + limit + "&offset=" + offset).then(r => r.json());
    }
